...
public class BankController {
    ...
    public String registrationForm(@RequestParam String username, @RequestParam String password, Model model) {
        try {
    ...
    public String deposit(@RequestParam BigDecimal amount) {
        ...
        return "redirect:/dashboard"; // Return to dashboard with error message
